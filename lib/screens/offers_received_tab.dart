...
class OffersReceivedTab extends StatefulWidget {
  const OffersReceivedTab({super.key});

  @override
  State<OffersReceivedTab> createState() => OffersReceivedTabState();
}

class OffersReceivedTabState extends State<OffersReceivedTab> with AutomaticKeepAliveClientMixin {
  @override
