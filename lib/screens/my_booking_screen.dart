...
class _MyBookingScreenState extends State<MyBookingScreen> {
  ...
  Future<void> _removeBid(int bookingId, String status) async {
    final confirm = await Get.dialog<bool>(
      AlertDialog(
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
        title: const Text('Remove Bid'),
        content: Text(
          status == 'confirmed'
              ? 'This bid was approved. Are you sure you want to remove it from your list?'
    ...
    try {
      ...
      if (deleteResponse.statusCode == 200) {
        Get.snackbar('Removed', 'Bid removed successfully!',
  ...
  Future<void> _contactSeller(dynamic item) async {
    ...
    final message  = Uri.encodeComponent(
        'Hi! I placed a bid on your "$itemName" listed for Nu. $price on JNEC Eco-trade. Can we proceed?');
          ...
          : _bookings.isEmpty
              ? Center(
                  child: Column(
                    ...
                    children: [
                      Icon(Icons.gavel, size: 70, color: Colors.grey.shade300),
                      const SizedBox(height: 16),
                      Text('No bids yet',
                          style: TextStyle(
                              color: Colors.grey.shade400, fontSize: 16)),
                      const SizedBox(height: 8),
                      Text('Place bids or browse items from the home screen',
                          style: TextStyle(
              ...
              : RefreshIndicator(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final isLost    = isAuction && status == 'cancelled';
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          // Contact button for non-auction pending
                                          ...
                                          // Contact seller for auction winner
                                          if (isWinner) ...[
                                            Expanded(
                                              child: SizedBox(
                                                height: 30,
