...
class _HomeScreenState extends State<HomeScreen> {
    ...
    return Scaffold(
              ...
              child: Obx(() {
                ...
                return RefreshIndicator(
                  ...
                  child: GridView.builder(
                    ...
                    itemBuilder: (context, index) => _buildItemCard(_homeController.items[index]),
                  ),
                );
              }),
            ),
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.shopping_cart_outlined), activeIcon: Icon(Icons.shopping_cart), label: 'My Cart'),
  ...
  Widget _buildItemCard(dynamic item) {
    // ✅ FIXED: use ImageHelper to handle both single and JSON array images
