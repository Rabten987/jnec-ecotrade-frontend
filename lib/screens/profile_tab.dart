...
class ProfileTabState
  ...
  // ✅ Confirm and log out — moved here from the old bottom nav
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          // ✅ Logout moved here since the bottom nav is now the shared
          // 5-tab nav and no longer has a dedicated Logout slot
          IconButton(
