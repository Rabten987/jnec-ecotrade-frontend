...
class HomeTabState extends State<HomeTab> with AutomaticKeepAliveClientMixin {
  ...
  // ✅ Checks if an item's auction has ended
  bool _isAuctionEnded(dynamic item) {
    final auctionVal = item['auction_enabled'];
    final isAuction  = auctionVal == true || auctionVal == 1 || auctionVal.toString() == 'true';
    if (!isAuction || item['auction_ends_at'] == null) return false;
    try {
        ...
        child: Column(
          ...
          children: [
                      ...
                      return Stack(
                        children: [
                          CircleAvatar(
                            ...
                            child: avatar.isEmpty ? const Icon(Icons.person, size: 55, color: Colors.grey) : null,
                          ),
                          Positioned(
                            bottom: 0, right: 0,
                            child: Container(
            ...
            ListTile(
              ...
              title: const Text('My Profile', style: TextStyle(fontSize: 15, color: Colors.black87, fontWeight: FontWeight.w500)),
            ...
            ListTile(
              ...
              title: const Text('Favourite', style: TextStyle(fontSize: 15, color: Colors.black87, fontWeight: FontWeight.w500)),
            ...
            ListTile(
              ...
              title: const Text('Log Out', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500, color: Colors.black87)),
        ...
        child: Column(
          ...
          children: [
            ...
            const Padding(
              ...
              child: Text('Categories', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.black87)),
            ),
            ...
            Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  const Text('Browse Items', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.black87)),
                  Obx(() {
                    // ✅ Count only visible (non-ended) items
                    final visibleCount = _homeController.items
                        .where((item) => !_isAuctionEnded(item))
                        .length;
                    return Text('$visibleCount items',
            ...
            Expanded(
              child: Obx(() {
                ...
                // ✅ Filter out items whose auction has ended
                final visibleItems = _homeController.items
                    .where((item) => !_isAuctionEnded(item))
                    .toList();
                ...
                return MediaQuery(
                  ...
                  child: GridView.builder(
                    ...
                    gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                      ...
                      mainAxisSpacing: 10, mainAxisExtent: 210,
                    ),
  ...
  Widget _buildItemCard(dynamic item) {
    final imageBytes = ImageHelper.getFirstImage(item['image']);
                ...
                if (isAuction)
                  Positioned(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(color: Colors.teal.shade600, borderRadius: BorderRadius.circular(6)),
                      child: const Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          Icon(Icons.gavel, color: Colors.white, size: 10),
                          SizedBox(width: 3),
                          Text('AUCTION', style: TextStyle(color: Colors.white, fontSize: 8, fontWeight: FontWeight.bold)),
                        ],
                      ),
                    ),
                  ),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('Nu ${item['price']}',
                      style: TextStyle(color: Colors.teal.shade600, fontSize: 11, fontWeight: FontWeight.w600)),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text(isAuction ? 'Bid Now' : 'View',
