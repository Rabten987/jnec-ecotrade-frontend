...
class PostTabState extends State<PostTab> with AutomaticKeepAliveClientMixin {
  ...
  void _resetForm() {
    ...
    // ✅ Contact number is intentionally kept — it's the user's own number,
    // re-filled automatically anyway via _autoFillContact on screen load
  }
